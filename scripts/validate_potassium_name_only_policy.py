...
def validate(doc):
    ...
    ck("name_only == 16,503 (C 16,508 → v1.2 draft 클로르탈리돈2+인다파미드3 flip)", len(no) == 16503, f"name_only {len(no)}")
    ck("relation_card == 1,077 (C 1,072 → v1.2 draft +5)", len(rc) == 1077, f"relation_card {len(rc)}")
