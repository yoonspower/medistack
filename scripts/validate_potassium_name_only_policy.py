...
def validate(doc):
    ...
    ck("name_only == 16,604 (v1.1 relation 확장 17,022→16,604·418 flip)", len(no) == 16604, f"name_only {len(no)}")
    ck("relation_card == 976 (v1.1 relation 확장 558→976·+418)", len(rc) == 976, f"relation_card {len(rc)}")
